...
export default function MedicoInicio({ navigation }) {
  ...
  const loadMedicoData = async () => {
    try {
      const horariosResult = await AuthService.getHorariosPorMedico();
  ...
  <View style={styles.actionsGrid}>
    ...
    <TouchableOpacity
      style={styles.actionCard}
      onPress={() => NavigationService.navigate('HorariosStack', { screen: 'MisHorarios' })}
    >
    ...
    <TouchableOpacity
      style={styles.actionCard}
      onPress={() => NavigationService.navigate('EspecialidadStack', { screen: 'MiEspecialidad' })}
    >
