...
export default function PacienteInicio({ navigation }) {
  ...
  const loadPacienteData = async () => {
    try {
      const EspecialidadResult = await AuthService.getEspecialidad();
      if (EspecialidadResult.success) {
        setEspecialidad(EspecialidadResult.data);
      }
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.actionsContainer}>
          ...
          <TouchableOpacity
            style={styles.actionCard}
            onPress={() => NavigationService.navigate('HorariosStack', { screen: 'VerHorarios' })}
          >
