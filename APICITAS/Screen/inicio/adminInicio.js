      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.actionsContainer}>
          ...
          <View style={styles.actionsGrid}>
            ...
            <TouchableOpacity
              style={styles.actionCard}
              onPress={() => NavigationService.navigate('EspecialidadStack', { screen: 'ListarEspecialidad' })}
            >
              <MaterialCommunityIcons name="medical-bag" size={40} color="#dac407ff" />
              <Text style={styles.actionTitle}>Especialidad</Text>
              <Text style={styles.actionDescription}>Gestionar Especialidad</Text>
            </TouchableOpacity>

            <TouchableOpacity
              style={styles.actionCard}
              onPress={() => NavigationService.navigate('HorariosStack', { screen: 'ListarHorarios' })}
            >
